...
public class ApiHelper {
    ...
    private String ipAdress = "145.48.227.148",port = "8081";
    public final String luxUpdate = "lux/update/",get = "lux/get",
                   add = "addKaku/",
                   getAll = "getKakus",
                   remove = "removeKaku/";
    ...
    public String getRandomQuote(){
        int idx = new Random().nextInt(getQuotes().length);
        return getQuotes()[idx];
    }

    private String[] getQuotes(){
        String[] quotes = {"That\'ll be our little secret.",
